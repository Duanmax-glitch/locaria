...
function viewContrato(idContrato){
  ...
  const body=`
    ...
    ${grp('Reajustes','<path d="M23 6l-9.5 9.5-5-5L1 18"/><path d="M17 6h6v6"/>',
      ...
      + (proximoReajuste(c) ? `<div class="dv-row"><span class="dv-l">Próximo reajuste</span><span class="dv-v">${new Date(proximoReajuste(c)+'T00:00').toLocaleDateString('pt-BR')}</span></div>` : ''))}
