...
function renderTopActions(v){
  const a=$('#topActions');
  const sync=`<button class="btn ghost" onclick="refresh()"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M23 4v6h-6M1 20v-6h6"/><path d="M3.51 9a9 9 0 0114.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0020.49 15"/></svg><span>Atualizar</span></button>`;
  const map={
    dashboard: '',
    cobrancas:`<button class="btn primary" onclick="openForm('cobrancas')"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round"><path d="M12 5v14M5 12h14"/></svg><span>Nova Cobrança</span></button>`,
    inquilinos:`<button class="btn primary" onclick="openForm('inquilinos')"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round"><path d="M12 5v14M5 12h14"/></svg><span>Novo Inquilino</span></button>`,
    contratos:`<button class="btn primary" onclick="openForm('contratos')"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round"><path d="M12 5v14M5 12h14"/></svg><span>Novo Contrato</span></button>`,
    vistorias:`<button class="btn primary" onclick="openForm('vistorias')"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round"><path d="M12 5v14M5 12h14"/></svg><span>Nova Vistoria</span></button>`,
    imoveis:`<button class="btn primary" onclick="openForm('imoveis')"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round"><path d="M12 5v14M5 12h14"/></svg><span>Novo Imóvel</span></button>`,
    manutencoes:`<button class="btn primary" onclick="openForm('manutencoes')"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round"><path d="M12 5v14M5 12h14"/></svg><span>Nova Manutenção</span></button>`,
    regras:`<button class="btn primary" onclick="openForm('regras')"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round"><path d="M12 5v14M5 12h14"/></svg><span>Nova Regra</span></button>`,
    proprietario:'',
  };
