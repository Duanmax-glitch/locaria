...
function initGoogleSignIn(){
  ...
  // O GIS renderiza o botão em 2 etapas (genérico → personalizado "Entrar como…"),
  // o que causa o "flash do G gigante" ao abrir. Escondemos durante o render — com o
  // espaço já reservado via min-height no CSS (sem pulo de layout) — e revelamos
  // quando estabiliza. O reveal usa setTimeout (sempre dispara), então o botão nunca
  // fica preso invisível mesmo que algo falhe.
  ...
  setTimeout(() => { btnEl.style.opacity = '1'; }, 450);
}
function mostrarApp(){
